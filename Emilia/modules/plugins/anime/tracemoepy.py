...
from Emilia.modules.plugins.anime.anilist import no_pic
...
@control_user
async def trace_bekkkkkk(client: Client, message: Message, mdata: dict):
    ...
    if dls_loc:
        ...
        button.append(
            [InlineKeyboardButton("》", callback_data=f"tracech_1_{dls_js}_{user}")]
        )
        try:
