...
from Emilia.modules.plugins.greetings.captcha.captcharules_button import (
    ruleCaptchaButton,
)
from Emilia.modules.plugins.greetings.utils.actions import failedAction, passedAction
from Emilia.modules.plugins.greetings.utils.captcha_text_gen import ButtonGen
from Emilia.modules.plugins.greetings.utils.random_string_gen import (
    RandomStringGen,
    mathCaptchaGen,
)
    ...
    if _match in ["text", "math"]:
        ...
        if new_user_id == user_id:
            ...
            if await isUserAdmin(
                ...
                await message.reply("This wasn't for you.")
