...
# Use the central db from Emilia to avoid duplicate clients
from Emilia import db as _DATABASE
from Emilia.utils.constants import COLL, normalize_filter

# Reuse the shared DB instead of creating a new client per module

COLLECTIONS = COLL  # re-export for convenience
...
def find_one(
    name: str, flt: Dict[str, Any], projection: Optional[Dict[str, int]] = None
):
